...
require (
	...
	go.bytebuilders.dev/lib-selfhost v0.0.10-0.20251216135250-9b9c2715e853
...
require (
	...
	go.bytebuilders.dev/catalog v0.0.16 // indirect
	go.bytebuilders.dev/installer v0.1.1-0.20251216135020-29fd8dfa58d3 // indirect
	go.bytebuilders.dev/resource-model v0.3.1 // indirect
	go.bytebuilders.dev/ui-wizards v0.28.1 // indirect
	...
	kmodules.xyz/resource-metadata v0.40.1 // indirect
	kubeops.dev/external-dns-operator v0.0.9 // indirect
	kubeops.dev/installer v0.0.0-20251215120607-2679d0cb5864 // indirect
